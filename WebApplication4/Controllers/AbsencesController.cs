...
namespace WebApplication4.Controllers
{
    ...
    public class AbsencesController : ControllerBase
    {
        ...
        public AbsencesController(StudentContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Absence>> PostAbsence(Absence absence)
        {
            ...
            return CreatedAtAction("GetAbsence", new { id = absence.Absid }, absence);
        }
        ...
        {
            return _context.Absence.Any(e => e.Absid == id);
        }
    }
}
*/